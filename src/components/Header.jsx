...
const Header = () => {
  ...
  return (
    <header className="font-Lato px-5">
      <div className="max-w-[1260px] flex justify-between items-center mx-auto  h-24">
        ...
        <div className="w-full max-w-[345px] relative">
          <div className="flex items-center border-2 border-[#D9D9D9] rounder-xl px-3 py-2.5">
            ...
            <button
              ...
              className="flex items-center text-sm text-[#262626] border-r border-[#D9D9D9] pr-3 mr-3 cursor-pointer"
            >
              <p>All categories</p>
              <img
                src={dropdownBlack}
